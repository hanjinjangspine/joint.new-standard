...
export const hospitalInfo = {
  ...
  commonNotice:
    "새기준병원 관절센터입니다. 진료시간과 예약은 방문 전에 확인해 주세요.",
  officialRelationship:
    "병원 전체 진료와 이용 정보는 본원 홈페이지에서, 관절 질환별 안내는 관절센터 사이트에서 확인할 수 있습니다.",
  officialRoleSeparation:
    "새기준병원 본원 홈페이지는 병원 전체 진료와 이용 정보를 안내하고, 관절센터 사이트는 부위·질환별 진료 정보를 자세히 설명합니다."
};
...
export const clinicHoursSummary = {
  footer: "평일 08:30-12:30, 13:30-17:30 (점심 12:30-13:30) / 토요일 08:30-12:30 / 일요일 09:00-13:00 (토·일 점심시간 없음)",
  contactNotice:
...
export const columnDetails: Record<string, ColumnDetail> = {
  ...
  "ankle-ligament-tear-treatment": {
    ...
    sections: [
      ...
      { title: "수술적 치료 상담이 필요한 경우", body: ["충분한 재활 후에도 발목이 반복해 접질리거나, 진찰에서 불안정성이 확인되고 연골 손상 등 동반 문제가 있는 경우에는 수술 상담을 고려할 수 있습니다.", "수술 여부는 손상 정도뿐 아니라 활동 수준, 직업, 보행 불편, 기존 치료 반응을 함께 확인해 결정합니다."] },
  ...
  "shoulder-night-pain": {
    ...
    readingTime: "약 4분",
    sections: [
      { title: "밤에 어깨 통증이 심해지는 이유", body: ["밤에 어깨 통증이 심하면 잠을 자다가 깨거나 아픈 쪽으로 눕기 어려워질 수 있습니다.", "밤에는 움직임이 줄고 같은 자세로 오래 누워 있어 통증을 더 뚜렷하게 느낄 수 있습니다. 야간통만으로 원인을 단정할 수는 없습니다."] },
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 통증이 심해지는 자세, 어깨 운동 범위, 근력, X-ray·초음파·MRI 결과를 함께 확인합니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
  ...
  "arm-raising-shoulder-pain": {
    ...
    sections: [
      ...
      { title: "어떤 경우에 검사가 필요할까요?", body: ["며칠 쉬어도 통증이 줄지 않거나 팔을 드는 동작이 어려워 일상생활에 지장이 있으면 진료를 고려하는 것이 좋습니다.", "힘이 뚜렷하게 빠지거나 야간통이 동반되면 초음파나 MRI로 힘줄 상태를 확인할 수 있습니다."] },
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 팔을 올리는 각도, 의료진이 움직여 볼 때의 범위, 어깨 근력, 통증 위치, 영상검사 결과를 함께 봅니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
  ...
  "knee-joint-effusion": {
    ...
    sections: [
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 무릎 붓기 정도, 열감, 통증 위치, 관절 운동 범위, 기존 치료 반응과 영상검사 결과를 함께 봅니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
  ...
  "stair-descent-knee-pain": {
    ...
    sections: [
      ...
      { title: "어떤 경우에 검사가 필요할까요?", body: ["며칠 쉬어도 통증이 줄지 않거나 계단을 피하게 될 정도로 불편하면 진찰과 X-ray를 통해 관절 간격과 정렬을 먼저 확인할 수 있습니다.", "무릎 잠김, 반복적인 붓기, 외상 이후 통증이 있으면 MRI 같은 정밀검사를 고려할 수 있습니다."] },
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 통증 위치, 계단 보행 양상, 무릎 운동 범위, 하지 정렬, X-ray와 MRI 결과를 함께 확인합니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
  ...
  "plantar-pain-differential": {
    ...
    sections: [
      ...
      { title: "어떤 경우에 검사가 필요할까요?", body: ["며칠 쉬어도 통증이 줄지 않거나 발을 디딜 때 심해지는 경우, 붓기나 저림이 동반되는 경우에는 진료가 필요할 수 있습니다.", "X-ray로 뼈와 정렬을 먼저 확인하고, 필요하면 초음파나 MRI로 근막, 신경, 피로골절 여부를 확인합니다."] },
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 발바닥 통증 위치, 보행 양상, 발 아치, 신발 착용 습관, X-ray와 필요한 영상검사를 함께 확인합니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
  ...
  "shoulder-mri-timing": {
    ...
    sections: [
      ...
      { title: "새기준병원 관절센터에서는 무엇을 함께 확인하나요?", body: ["새기준병원 관절센터는 어깨 운동 범위, 근력, 통증 양상, X-ray·초음파·MRI 결과를 함께 확인합니다.", "치료는 증상과 진찰 소견, 필요한 검사 결과를 종합해 정합니다."] },
      { title: "자주 묻는 질문", body: ["Q. 초음파와 MRI는 무엇이 다른가요? A. 초음파는 힘줄의 움직임과 주변 조직을 실시간으로 확인하는 데 도움이 되고, MRI는 파열 범위와 관절 주변 구조를 넓게 살피는 데 도움이 됩니다.", "Q. MRI에서 파열이 보이면 수술해야 하나요? A. 파열 크기, 증상, 근력 저하, 생활 제한을 함께 확인해 치료 방향을 상담합니다.", "Q. 어깨 MRI는 언제까지 미뤄도 되나요? A. 통증이 가볍고 호전 중이면 경과를 볼 수 있지만 힘 빠짐이나 야간통이 지속되면 진료를 권합니다."] }
    ]
  },
  "knee-pain-yongin": {
