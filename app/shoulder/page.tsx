  ...
  return (
    <>
      ...
      <main>
        ...
        <PatientGuideSection
          guideIds={["08", "21", "22", "24", "29", "35", "36"]}
          title="어깨 질환별 판단 기준을 자세히 확인하세요"
          description="석회화 건염, 회전근개 건병증·파열, 오십견, 반복 탈구, 어깨 위쪽 관절 탈구와 어깨 인공관절 치환술의 증상·검사·치료·회복 내용을 확인할 수 있습니다."
          tone="white"
        />
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-4xl">
              <p className="mb-3 text-sm font-bold uppercase text-brand-600">다른 원인과 구분</p>
              <h2 className="text-3xl font-extrabold leading-tight text-ink sm:text-4xl">
